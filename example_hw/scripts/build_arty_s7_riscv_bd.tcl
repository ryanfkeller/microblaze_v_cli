################################################################
# This is a generated script based on design: arty_s7_riscv_bd
#
...
# source arty_s7_riscv_bd_script.tcl
...
set design_name arty_s7_riscv_bd
...
proc write_mig_file_arty_s7_riscv_bd_mig_7series_0_0 { str_mig_prj_filepath } {
   ...
   puts $mig_prj_file {  <ModuleName>arty_s7_riscv_bd_mig_7series_0_0</ModuleName>}
...
# End of write_mig_file_arty_s7_riscv_bd_mig_7series_0_0()
...
proc create_root_design { parentCell } {
  ...
  set ddr_clk [ create_bd_port -dir I -type clk -freq_hz 100000000 ddr_clk ]
  ...
  write_mig_file_arty_s7_riscv_bd_mig_7series_0_0 $str_mig_file_path
  ...
  connect_bd_intf_net -intf_net microblaze_riscv_0_M_AXI_DC [get_bd_intf_pins microblaze_riscv_0/M_AXI_DC] [get_bd_intf_pins microblaze_riscv_0_axi_periph/S01_AXI]
  connect_bd_intf_net -intf_net microblaze_riscv_0_M_AXI_IC [get_bd_intf_pins microblaze_riscv_0/M_AXI_IC] [get_bd_intf_pins microblaze_riscv_0_axi_periph/S02_AXI]
  ...
  connect_bd_intf_net -intf_net microblaze_riscv_0_axi_periph_M03_AXI [get_bd_intf_pins microblaze_riscv_0_axi_periph/M03_AXI] [get_bd_intf_pins mig_7series_0/S_AXI]
  ...
  connect_bd_net -net ddr_clk_1  [get_bd_ports ddr_clk] \
  [get_bd_pins util_ds_buf_0/BUFG_I]
  connect_bd_net -net ddr_clock_1  [get_bd_pins util_ds_buf_0/BUFG_O] \
  ...
  connect_bd_net -net microblaze_riscv_0_Clk  [get_bd_pins clk_wiz_0/clk_out2] \
  ...
  assign_bd_address -offset 0x41200000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_riscv_0/Instruction] [get_bd_addr_segs microblaze_riscv_0_axi_intc/S_AXI/Reg] -force
